...
where amount >1.00
and payment_date between '17-06-2005 00:00:00' and '19-06-2005 23:59:59'
...
select 
concat(last_name, ' ', first_name) as "ФИО", 
email as "Эл.почта", 
char_length(email) as "Кол-во символов email", 
...
where active = '1'
and (concat(first_name, last_name) like '%KELLY%' or concat(first_name, last_name) like '%WILLIE%');
